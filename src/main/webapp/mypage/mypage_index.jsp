...
$(function(){
	...
	$("#btnUpdate").click(function() {
		...
		var frm=$("#frm")[0];//parameter 전송방식 : 파일 업로드 x
...
MemberDTO mDTO=ms.searchMemberDTO(id);
if( mDTO == null){
...
<img src="${ mDTO.profile_img eq 'default.jpg'?"../common/images": uploadURL }/
	 ...
	 <input type="file" style="display: none" id="profileImg" name="profileImg" accept="image/*"/>
</div>
<table style="float: left;clear: both; border: medium;">
<tr>		 
<td>이름</td>
...
<td>
	...
	value="남자"${ mDTO.gender eq '남자'? 'checked="checked"':'' }/> 남자
	<input type="radio" name="gender" 
	value="여자"${ mDTO.gender eq '여자'? 'checked="checked"':'' }/> 여자
</td>
</tr>
<tr>		 
<td>가입시 사용된 ip adress</td>
<td><c:out value="${ mDTO.ip }"/> </td>
</tr>
<tr>		 
<td>가입일</td>
<td><fmt:formatDate value="${ mDTO.input_date }" 
		pattern="yyy-MM-dd a EEEE HH:mm"/> </td>
</tr>
<tr>		 
