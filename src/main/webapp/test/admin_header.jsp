...
<div class="sidebar">
    ...
    <div class="logo-container">
        <div class="logo-img">
            <img src="http://localhost/jsp_prj/test/images/logo.png" alt="메인 로고" />
        </div>
    ...
    <div class="menu-category">
        ...
        <div class="menu-item"><span>▶</span>상영스케줄 목록</div>
        <div class="menu-item"><span>▶</span>상영 등록</div>
    </div>
    <div class="menu-category">
...
<div class="header-container">
    <div class="header-buttons">
        <a href="#" class="header-button">
            <img src="http://localhost/jsp_prj/test/images/home_icon.png" alt="홈 아이콘" class="button-icon">
            메인으로
        </a>
        <a href="#" class="header-button">
            <img src="http://localhost/jsp_prj/test/images/signOut_icon.png" alt="로그아웃 아이콘" class="button-icon">
            로그아웃
        </a>
    </div>
</div>
