     ...
     $("#id").keyup(function(evt) {
    	 ...
    	 if( id.length > 5){
    		 ...
    		 $.ajax({
				...
				dataType:"JSON",
				error: function( xhr ) {
					alert("버튼 눌러서 팝업창을 중복검사하세요");
					console.log( xhr.status );
				},
				success: function( jsonObj ) {
					var msg=jsonObj.idFlag?"사용가능":"이미 사용중";
					var color="#FF0000";
					if( jsonObj.idFlag ){
						msg="사용가능";
						color="#0000FF";
...
<div id="container">
   ...
   <iframe src="http://192.168.10.76/html_prj/css0410/scrollbar.html" 
   style="border: 0px; width: 1420px;height: 200px"></iframe>
   
   
   <form action="member_frm_output.jsp" name="frm" id="frm" method="post">
      <table>
         <tr>
            <th>* 아이디</th>
