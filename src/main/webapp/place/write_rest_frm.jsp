...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.499317, 127.033181), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
    ...
    var resultDiv = document.getElementById('clickLatlng');//바닐라 자바스크립
...
$("#btnAdd").click(function() {
	...
	if(confirm("식당 정보를 입력하시려면 로그인이 하셔야합니다.\n 로그인 하시겠습니까?")){
