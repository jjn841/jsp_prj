...
<style type="text/css">
 ...
 #boardWrap{ text-align: left;}
 #pagenationDiv{ text-align: center;}
.pagePrevMark{ color: #FF0000;}
.pageCurrent{ font-weight: bold; font-size: 20px;}
.pageNotCurrent{ font-weight: normal;}
...
<h3>맛집리스트</h3>
<div id="boardWrap" style="width:1200px; height:580px; margin: 0px aout; ">
...
int pageScale=0;//한화면에 보여줄 게시물의 수(boardService)
pageScale=ps.pageScale();

/* int totalPage=totalCount/pageScale;;
if( totalCount%pageScale != 0 ){//딱 떨어지는 수
	totalPage++;
} */
int totalPage=0;// 한 화면에 보여줄 총 게시물의 수
...
List<RestDTO> restList=ps.searchRestaurant(rDTO);//시작번호와 끝번호사이 리스트조회
...
PaginationDTO pDTO=new PaginationDTO(3, rDTO.getCurrentPage(),totalPage,
		"restaurant_list.jsp",//다른 jsp를 쓰고싶으면 이것만 바꾸면 된다
