...
//out.print( chk );//checked되지 않으면 null, value 속성이 없는 상태에서 checked되면 "on"
...
//2.생존시간 설정
cookieName.setMaxAge(60*60); //1시간
cookieAge.setMaxAge(60*60*1); //1분
cookieSave.setMaxAge(60*60*24); //24h//이름이 1신간이면 맞지 않는다.
//3.쿠키 심기
