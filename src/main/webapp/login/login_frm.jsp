...
<main class="form-signin w-100 m-auto">
  <form name="loginFrm" action="#void">
    ...
    <div class="form-floating">
      <input type="text" value="kim44" class="form-control" name="id" id="floatingInput" placeholder="아이디">
      <label for="floatingInput">아이디</label>
    </div>
    <div class="form-floating">
      <input type="password" value="123" class="form-control" name="pass" id="floatingPassword" placeholder="비밀번호">
