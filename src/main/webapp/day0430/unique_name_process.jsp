...
//txt=1&pass=2&file=img_5.jpg&hid=5월+1일+근로자의+날+안쉼.&flag=flag&sel=자바&ta=33

//입려되는 문자열을 모두 encoding
//POST방식에 한글을 입력받는 JSP에서 
request.setCharacterEncoding("UTF-8");

String txt=request.getParameter("txt");//<input type="text" name="txt">
String pass=request.getParameter("pass");//<input type="password" nam="pass">
...
String sel=request.getParameter("sel");//<select type="sel">
