	...
	$("#btn").click(function(){
		$.ajax({
			...
			success: function( jsonObj){
				...
				$("#creatDate").html(jsonObj.pubDate );	
			...
			/* 	$.each( jsonObj.data, function( i, jsonTemp){
					...
					jsonTemp.deptno+")'>"+jsonTemp.deptno+"</td><td>"+
					jsonTemp.dname+
				...
				$.each(jsonObj.data, function(i, jsonTemp) {
	                var createTr = "<tr><td><a href='javascript:searchEmp(" 
	              		+ jsonTemp.deptno + ")'>" +jsonTemp.deptno + 
	              		"</a></td><td>" + jsonTemp.dname +
	                    "</td><td>" + jsonTemp.loc + "</td></tr>";
...
<h2>[<span id="deptno" style="width: 80px;"></span>]번부서 사원정보</h2>
