...
//ld.setId(new Random().nextBoolean()? "kim22":"kim1");
...
style="width:520px; border: 1pxs solid #CDCDCD; height:30px;"  ></td>
</tr>
<tr>
<td>내용</td>
<td>
